DROP FUNCTION APPS.XXSS_INCMPLT_PO_NUM;

CREATE OR REPLACE FUNCTION APPS.XXSS_INCMPLT_PO_NUM(P_ITEM_ID NUMBER,P_RANK_NUM NUMBER)
RETURN varchar2
as
...
RETURN L_PO_NUM;
   ...
   return l_po_num;
end XXSS_INCMPLT_PO_NUM;
/


GRANT EXECUTE ON APPS.XXSS_INCMPLT_PO_NUM TO XXAPPSREAD;
