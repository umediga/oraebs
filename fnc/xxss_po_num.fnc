DROP FUNCTION APPS.XXSS_PO_NUM;

CREATE OR REPLACE FUNCTION APPS.XXSS_PO_NUM(p_item_id number,P_RANK_NUM NUMBER)
return varchar2
as
...
GRANT EXECUTE ON APPS.XXSS_PO_NUM TO XXAPPSREAD;
