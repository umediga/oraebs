DROP FUNCTION APPS.XXSS_REAPP_PO_NUM;

CREATE OR REPLACE FUNCTION APPS.XXSS_REAPP_PO_NUM(P_ITEM_ID NUMBER,P_RANK_NUM NUMBER)
RETURN varchar2
as
L_PO_NUM varchar2(200);
begin
SELECT   PO_NUM INTO L_PO_NUM
                                   ...
                                   WHERE   1 = 1
                                           ...
                                           AND PLL.SHIPMENT_TYPE IN
                                                    ('STANDARD',
                                                     'SCHEDULED',
                                                     'BLANKET')
                                           --  AND NVL (PLL.APPROVED_FLAG, 'N') IN ('R')
...
RETURN L_PO_NUM;
   ...
   return l_po_num;
end XXSS_REAPP_PO_NUM;
/


GRANT EXECUTE ON APPS.XXSS_REAPP_PO_NUM TO XXAPPSREAD;
