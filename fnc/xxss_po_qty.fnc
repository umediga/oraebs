DROP FUNCTION APPS.XXSS_PO_QTY;

CREATE OR REPLACE FUNCTION APPS.XXSS_PO_QTY(P_ITEM_ID NUMBER,P_RANK_NUM NUMBER)
RETURN number
as
L_PO_NUM varchar2(200);
begin
SELECT   SUM (QUANT) into l_po_num
                          FROM   (SELECT   PLL.QUANTITY QUANT,
...
RETURN L_PO_NUM;
    ...
    WHEN TOO_MANY_ROWS THEN
     L_PO_NUM :='Same PO Quantity';
   return l_po_num;
end XXSS_PO_QTY;
/


GRANT EXECUTE ON APPS.XXSS_PO_QTY TO XXAPPSREAD;
