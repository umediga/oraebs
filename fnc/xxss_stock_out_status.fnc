DROP FUNCTION APPS.XXSS_STOCK_OUT_STATUS;

CREATE OR REPLACE FUNCTION APPS.XXSS_STOCK_OUT_STATUS(P_ITEM_ID NUMBER,P_RANK_NUM NUMBER)
RETURN varchar2
as
L_NEED_BY varchar2(200);
begin
SELECT   NEED_BY  INTO L_NEED_BY
              FROM   (SELECT   to_char(PLL.PROMISED_DATE,'MONTH') NEED_BY,
...
RETURN L_NEED_BY;
   ...
   return l_need_by;
end XXSS_STOCK_OUT_STATUS;
/


GRANT EXECUTE ON APPS.XXSS_STOCK_OUT_STATUS TO XXAPPSREAD;
