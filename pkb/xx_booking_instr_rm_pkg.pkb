DROP PACKAGE BODY APPS.XX_BOOKING_INSTR_RM_PKG;

CREATE OR REPLACE PACKAGE BODY APPS."XX_BOOKING_INSTR_RM_PKG" 
IS
----------------------------------------------------------------------
/*
 Created By    : Ravi Vishnu
 Creation Date : 05-Nov-2014
 File Name     : XX_BOOKING_INSTR_RM_PKG
...
-------------------------------------
      ...
      DELETE FROM xxintg.xx_daily_booking_instr_rm_tmp;

      DELETE FROM xxintg.xx_daily_booking_instr_rm_main;
      ...
      INSERT INTO xxintg.xx_daily_booking_instr_rm_tmp
...
--                   AND TRUNC (oha.booked_date) BETWEEN '01-OCT-2014' AND '01-OCT-2014'
        ...
        IF l_database = 'PROD' THEN
		 ...
		 UPDATE xxintg.xx_daily_booking_instr_rm_tmp x
        ...
        INSERT INTO xxintg.xx_daily_booking_instr_rm_main
        SELECT * FROM xxintg.xx_daily_booking_instr_rm_tmp x
                WHERE 1=1
