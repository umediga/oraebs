DROP PACKAGE BODY APPS.XX_BACKORDER_NEURO_RM_PKG;

CREATE OR REPLACE PACKAGE BODY APPS."XX_BACKORDER_NEURO_RM_PKG" 
IS
----------------------------------------------------------------------
/*
...
-------------------------------------
      ...
      DELETE FROM xxintg.xx_backorder_neuro_rm_tmp;

      DELETE FROM xxintg.xx_backorder_neuro_rm_main;
      ...
      INSERT INTO xxintg.xx_backorder_neuro_rm_tmp
...
--         AND RES.RESOURCE_ID = NVL(:P_SALESREP, RES.RESOURCE_ID)
	...
	--	 AND jrb.manager_flag <> 'Y'  --Exclude Manager
        ...
        IF l_database = 'PROD' THEN
		 ...
		 UPDATE xxintg.xx_backorder_neuro_rm_tmp x
        ...
        INSERT INTO xxintg.xx_backorder_neuro_rm_main
        SELECT * FROM xxintg.xx_backorder_neuro_rm_tmp x
                WHERE 1=1
