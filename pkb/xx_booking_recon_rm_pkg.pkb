DROP PACKAGE BODY APPS.XX_BOOKING_RECON_RM_PKG;

CREATE OR REPLACE PACKAGE BODY APPS."XX_BOOKING_RECON_RM_PKG" 
IS
----------------------------------------------------------------------
/*
...
-------------------------------------
      ...
      DELETE FROM xxintg.xx_daily_booking_recon_rm_tmp;

      DELETE FROM xxintg.xx_daily_booking_recon_rm_main;
      ...
      INSERT INTO xxintg.XX_DAILY_BOOKING_RECON_RM_TMP
...
--                   AND TRUNC (oha.booked_date) BETWEEN '01-OCT-2014' AND '01-OCT-2014'
        ...
        IF l_database = 'PROD' THEN
		 ...
		 UPDATE xxintg.xx_daily_booking_recon_rm_tmp x
        ...
        INSERT INTO xxintg.xx_daily_booking_recon_rm_main
        SELECT * FROM xxintg.xx_daily_booking_recon_rm_tmp x
                WHERE 1=1
