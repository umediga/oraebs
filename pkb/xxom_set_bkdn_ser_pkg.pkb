DROP PACKAGE BODY APPS.XXOM_SET_BKDN_SER_PKG;

CREATE OR REPLACE PACKAGE BODY APPS."XXOM_SET_BKDN_SER_PKG" IS
...
select mtt.transaction_type_name,
 ...
 where mmt.transaction_type_id in (54, 62)  -- = 62
   ...
   and subinv.location_id = mmt.ship_to_location_id
   ...
   and TRUNC(mmt.transaction_Date) >= '01-MAY-2014'--to_date('01-MAY-2014','DD-MON-RRRR')--FND_DATE.CANONICAL_TO_DATE(l_trans_date)
     ...
     --                             from org_organization_definitions where organization_id=l_to_orgn_id)
       ...
       cursor c_xx_set_creation_date(cp_item_id in number, cp_serial_number in varchar2) IS
        SELECT max(created_date)
          from xxintg.xx_set_info
         where inventory_item_id = cp_item_id
           and serial = cp_serial_number;
                              ...
                              AND organization_id = p_from_orgn_id;
                                   EXCEPTION
                                      WHEN NO_DATA_FOUND THEN
                                        v_lot_exp_date := NULL;
                                      WHEN OTHERS THEN
                                        dbms_output.put_line('Error Deriving v_lot_exp_date');
...
--                                       WHEN OTHERS THEN
--                                         dbms_output.put_line('Error Deriving l_tran_type_name');
--                                         dbms_output.put_line('Error is :'||sqlcode ||' : '||sqlerrm );
--                                         l_tran_type_name := NULL;
--                                         RAISE e_validation_error;
--                     END;
                   ...
                   -- Inserting into staging table from cursor
                        ...
                        dbms_output.put_line('Before insert in loop');
                        INSERT INTO INTG_SET_BKDN_STG(  transaction_id,
                                                     ...
                                                     VALUES
                                                            ...
                                                            TO_CHAR(l_trans_date, 'DD-MON-YYYY HH24:MI:SS'),    --transaction_date
                       ...
                       dbms_output.put_line('Insert into INTG_SET_BKDN_STG for work order component: ' || r_work_order_components.transaction_id || ': ' ||
        ...
        END LOOP;
            ...
            if  l_wo_comp_found = 'T' then
                       ...
                       lv_count := lv_count + 1;
                       dbms_output.put_line('Insert into INTG_SET_BKDN_STG for work order number:' || r_work_order.wip_entity_name );
                       dbms_output.put_line('Insert into INTG_SET_BKDN_STG for work order number:' || r_work_order.wip_entity_name );
              else
                       dbms_output.put_line('Not Inserting into INTG_SET_BKDN_STG for work order number:' || r_work_order.wip_entity_name||' because component issues not found' );
                       dbms_output.put_line('Not Inserting into INTG_SET_BKDN_STG for work order number:' || r_work_order.wip_entity_name||' because component issues not found' );
              end if;  
   ...
   procedure process_xx_set(r_shipments c_shipments%rowtype) is
    begin
            ...
            dbms_output.put_line('Before c_xx_work_order loop:'||r_shipments.inventory_item_id ||'-'|| r_shipments.serial_number);
            FOR r_work_order IN c_xx_work_order(r_shipments.inventory_item_id, r_shipments.serial_number) LOOP                            
            l_wo_comp_found := 'T' ;
                 dbms_output.put_line('In c_xx_work_order loop:'||r_work_order.serial_number);
...
--                     END;
            ...
            exception when no_data_found then
              dbms_output.put_line(' Could not update set info for the children: ' || r_work_order_components.inventory_item_id );
            end;
            ...
            if  l_wo_comp_found = 'T' then
              ...
              exception when no_data_found then
                dbms_output.put_line(' Could not update set info for the parent: ' || r_work_order.primary_item_id );
              end;
...
dbms_output.put_line('Starting..');
                 dbms_output.put_line('p_from_orgn_id: ' || p_from_orgn_id
                 );
                 dbms_output.put_line(
  ...
  -- Get to organization code
   Select organization_code into v_to_orgn_code
     from org_organization_definitions where
          ...
          dbms_output.put_line(' To Org Code '||v_to_orgn_code);
  EXCEPTION
       WHEN OTHERS THEN
             dbms_output.put_line('Error Deriving v_org_code');
             dbms_output.put_line('Error is :'||sqlcode ||' : '||sqlerrm );
             v_to_orgn_code:= NULL;
             RAISE e_validation_error;
 END;
...
-- IF v_to_orgn_code = '150' THEN --
         ...
         BEGIN
              SELECT organization_code into v_org_code FROM  org_organization_definitions
               ...
               dbms_output.put_line(' From Org Code '||v_org_code);
         EXCEPTION
                      WHEN NO_DATA_FOUND THEN
                        v_org_code := NULL;
                      WHEN OTHERS THEN
                        ...
                        RAISE e_validation_error;
         END;
        dbms_output.put_line('Calling Shipments Loop');
  FOR r_shipments IN c_shipments LOOP
        dbms_output.put_line('In Shipments Loop');
        ...
        IF c_locator%notfound THEN
           dbms_output.put_line('Error Deriving Locator:'||r_shipments.loc_segment1||'.'||r_shipments.loc_segment2||'.'||r_shipments.loc_segment3);
           dbms_output.put_line('Unable to derive locator');
           close c_locator;
           raise e_validation_error;
        END IF;
        close c_locator;    
        ...
        dbms_output.put_line('Before Oepning c_wo_comp_date');
        open c_wo_comp_date(r_shipments.inventory_item_id, r_shipments.serial_number);
        dbms_output.put_line('Before Oepning c_xx_set_creation_date'); 
        ...
        dbms_output.put_line('After fetching c_wo_comp_date');
        ...
        dbms_output.put_line('After fetching c_xx_set_creation_date');
        ...
        if r_xx_set_creation_date is not null and r_xx_set_creation_date > nvl(r_wo_comp_date, to_date('1/1/1900', 'mm/dd/yyyy')) then  
             dbms_output.put_line('Entering process_xx_set Loop');
             process_xx_set(r_shipments);
             
        else     
            dbms_output.put_line('Entering process_work_order Loop');
        ...
        -- Insert Shipment only when wip component and issue were found
                INSERT INTO INTG_SET_BKDN_STG(  transaction_id,
                                     ...
                                     VALUES
                                           ...
                                           dbms_output.put_line('Insert Shipment int INTG_SET_BKDN_STG for order number:' || r_shipments.internal_order_number );
                                           dbms_output.put_line('Insert Shipment int INTG_SET_BKDN_STG for order number:' || r_shipments.internal_order_number );

         else
                                           dbms_output.put_line('Not Inserting Shipment because work order not found' );
                                           dbms_output.put_line('Not Inserting Shipment because work order not found' );
...
--nh ROLLBACK;
      ...
      dbms_output.put_line('Cannot create an Extract file.No Data loaded into Staging table' || SQLERRM);
...
PROCEDURE INTG_SET_BKDN_INS_PRC(l_from_orgn_id        IN NUMBER,
   ...
   -- Selecting number of records eligible for import from staging
          ...
          AND oracle_trans_type = 'WIP component issue' ;
             EXCEPTION
              WHEN OTHERS THEN
              dbms_output.put_line('unable to fetch count from ITGR_ORA_SET_BKDN_STG:');
              dbms_output.put_line('unable to fetch count from ITGR_ORA_SET_BKDN_STG: ' ||null);
         END;
   ...
   FOR R_TOP_ITEM IN C_TOP_ITEM LOOP
      ...
      dbms_output.put_line('x_return_status:'||x_return_status||' v_lpn_id:'||v_lpn_id );
      ...
      ******/
      ...
      FOR c1_rec in c1(R_TOP_ITEM.WORK_ORDER_NUMBER) LOOP
       ...
       apps.fnd_file.put_line (fnd_file.LOG,
             ...
             -- Fetching Transaction Interface ID from Sequence
              ...
              EXCEPTION
                 WHEN OTHERS THEN
                      ...
                      dbms_output.put_line('unable to fetch l_transaction_type_id:');
         ...
         -- Selecting distribution account
             ...
             -- dbms_output.put_line('Before checking l_err_msg');
              --IF l_err_msg IS NULL
              --THEN
                -- dbms_output.put_line('v_lot_control_code = '||v_lot_control_code ||' v_sno_control_code = '||v_sno_control_code);
                ...
                apps.fnd_file.put_line (fnd_file.LOG,
                 ...
                 THEN
                     ...
                     dbms_output.put_line('Bef Insert to MTL transaction inter1  ');
                     dbms_output.put_line('Bef Insert to MTL transaction inter1  ');
                     BEGIN
                ...
                ELSIF v_lot_control_code = 1 AND v_sno_control_code <> 1
                 THEN
                     dbms_output.put_line('Bef Insert to MTL and SER-->  ' || c1_rec.serial_number);
                     ...
                     dbms_output.put_line('Bef Insert to MTL transaction inte:2  ');
                     BEGIN
                          INSERT INTO apps.mtl_transactions_interface (
                                                             source_code,
                                                             source_line_id,
        ...
        --                insert into test123 values('mtl-ser');
                ...
                ELSIF v_lot_control_code = 1 AND v_sno_control_code = 1 THEN
                        BEGIN
                          dbms_output.put_line('Bef Insert to MTL transaction inter3  ');
                                                  apps.fnd_file.put_line (
                        ...
                        EXCEPTION
                           WHEN OTHERS THEN
                            ...
                            'Unable to insert into mtl_transaction_interface3 '
                             ...
                             dbms_output.put_line('Unable to insert into mtl_transaction_interface3 ' || SQLERRM);
                        END;
        ...
        --nh      COMMIT;
            ...
            END LOOP;
               ...
               dbms_output.put_line('Serial Number: ' || R_TOP_ITEM.serial_number || ' Parent_Item: ' ||R_TOP_ITEM.parent_item|| 
       ...
       END LOOP; --PARENT ITEM     
            ...
            dbms_output.put_line('No. of Records Inserted into Interface tables: ' || v_count1);

       COMMIT;

       fnd_file.put_line (fnd_file.OUTPUT, 'Submitting transaction for transaction header id: ' || l_txn_header_id);
       dbms_output.put_line('Submitting transaction for transaction header id: ' || l_txn_header_id);
      ...
      ,p_header_id => l_txn_header_id
       ...
       if txl_return_val <> 0 then 
          ...
          dbms_output.put_line('Return Status from INV_TXN_MANAGER_PUB: ' || txl_return_status||'-'||txl_msg_data);
       else

          fnd_file.put_line (fnd_file.OUTPUT, 'Return Success Status from INV_TXN_MANAGER_PUB: ' || txl_return_status);
          dbms_output.put_line('Return Status from INV_TXN_MANAGER_PUB: ' || txl_return_status);
       end if;
   ...
   EXCEPTION
      ...
      THEN
         ...
         dbms_output.put_line('Log_msg: ' || SQLERRM);
         v_count1:=null;
...
*/
      ...
      END;
                        ...
                        apps.fnd_file.put_line (
                           fnd_file.LOG,
                           'In procedure1 ITGR_ORA_SET_BKDN_EXT_PRC: ' || l_int_seq_no
           );
