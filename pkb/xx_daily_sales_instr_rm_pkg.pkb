DROP PACKAGE BODY APPS.XX_DAILY_SALES_INSTR_RM_PKG;

CREATE OR REPLACE PACKAGE BODY APPS."XX_DAILY_SALES_INSTR_RM_PKG" 
IS
----------------------------------------------------------------------
/*
...
-------------------------------------
      ...
      DELETE FROM xxintg.xx_daily_inv_instr_rm_tmp;

      DELETE FROM xxintg.xx_daily_inv_instr_rm_main;
      ...
      INSERT INTO xxintg.xx_daily_inv_instr_rm_tmp
...
--                                               )
	...
	AND UPPER(jrbt.role_name) NOT LIKE '%SPINE%'	 		--Added By Ravi Vishnu to exclude SPINE Dealers
         ...
         UPDATE xxintg.xx_daily_inv_instr_rm_tmp x
        ...
        INSERT INTO xxintg.xx_daily_inv_instr_rm_main
        SELECT * FROM xxintg.xx_daily_inv_instr_rm_tmp x
                WHERE 1=1
...
--                    AND invoice_no = '23258835'
				...
				COMMIT;
   END main;
END xx_daily_sales_instr_rm_pkg;
/
