DROP PACKAGE APPS.XX_AR_TRX_CNV_VALIDATIONS_PKG;

CREATE OR REPLACE PACKAGE APPS."XX_AR_TRX_CNV_VALIDATIONS_PKG" 
AS
----------------------------------------------------------------------
/*
 Created By    : Sharath Babu
 Creation Date : 24-FEB-2012
 File Name     : XXARTRXVAL.pks
...
----------------------------------------------------------------------
   ...
   FUNCTION pre_validations(p_trx_stg_rec IN xx_trx_conversion_pkg.G_XX_AR_CNV_STG_REC_TYPE) RETURN NUMBER;

   FUNCTION  data_validations (p_trxcnv_preiface_rec IN OUT xx_trx_conversion_pkg.G_XX_AR_CNV_PRE_STD_REC_TYPE ) RETURN NUMBER;

   FUNCTION  data_derivations (p_trxcnv_preiface_rec IN OUT xx_trx_conversion_pkg.G_XX_AR_CNV_PRE_STD_REC_TYPE ) RETURN NUMBER;
