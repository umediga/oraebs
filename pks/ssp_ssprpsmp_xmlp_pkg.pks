DROP PACKAGE APPS.SSP_SSPRPSMP_XMLP_PKG;

CREATE OR REPLACE PACKAGE APPS.SSP_SSPRPSMP_XMLP_PKG AUTHID CURRENT_USER AS
...
GRANT EXECUTE ON APPS.SSP_SSPRPSMP_XMLP_PKG TO INTG_NONHR_NONXX_RO;
