DROP PACKAGE APPS.SSP_ERN_DEL;

CREATE OR REPLACE PACKAGE APPS.ssp_ern_del AUTHID CURRENT_USER as
...
GRANT EXECUTE ON APPS.SSP_ERN_DEL TO INTG_NONHR_NONXX_RO;
