DROP PACKAGE APPS.SSP_MAT_DEL;

CREATE OR REPLACE PACKAGE APPS.ssp_mat_del AUTHID CURRENT_USER as
...
GRANT EXECUTE ON APPS.SSP_MAT_DEL TO INTG_NONHR_NONXX_RO;
