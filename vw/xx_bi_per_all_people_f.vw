DROP VIEW APPS.XX_BI_PER_ALL_PEOPLE_F;

/* Formatted on 6/6/2016 4:59:04 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_BI_PER_ALL_PEOPLE_F
(
   PERSON_ID,
...
AS
   SELECT "PERSON_ID",
          ...
          "MIDDLE_NAMES",
          "NATIONALITY",
          '999-99-9999' "NATIONAL_IDENTIFIER",
          "OFFICE_NUMBER",
          "ON_MILITARY_SERVICE",
          "ORDER_NAME",
          "PRE_NAME_ADJUNCT",
...
CREATE OR REPLACE SYNONYM ETLEBSUSER.PER_ALL_PEOPLE_F FOR APPS.XX_BI_PER_ALL_PEOPLE_F;


GRANT SELECT ON APPS.XX_BI_PER_ALL_PEOPLE_F TO SS_ETL_RO;

GRANT SELECT ON APPS.XX_BI_PER_ALL_PEOPLE_F TO XXAPPSREAD;
