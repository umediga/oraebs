DROP VIEW APPS.XX_IEX_INTL_CU_DLN_UWQ_V;

/* Formatted on 6/6/2016 4:58:27 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_IEX_INTL_CU_DLN_UWQ_V
(
   DLN_UWQ_SUMMARY_ID,
   ORG_ID,
   COLLECTOR_ID,
...
CREATE OR REPLACE SYNONYM XXAPPSREAD.XX_IEX_INTL_CU_DLN_UWQ_V FOR APPS.XX_IEX_INTL_CU_DLN_UWQ_V;


GRANT SELECT ON APPS.XX_IEX_INTL_CU_DLN_UWQ_V TO XXAPPSREAD;
