DROP VIEW APPS.XX_XRTX_PO_DOC_SUPP_V29;

/* Formatted on 6/6/2016 4:55:24 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_SUPP_V29
(
   OPERATING_UNIT,
   SUPPLIER_NAME,
   YEAR,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_po_doc_supp_v1 A,
          xx_xrtx_po_doc_supp_v2 b,
          xx_xrtx_po_doc_supp_v3 c,
          xx_xrtx_po_doc_supp_v4 d,
          xx_xrtx_po_doc_supp_v5 e,
          xx_xrtx_po_doc_supp_v6 f,
          xx_xrtx_po_doc_supp_v7 g
