DROP VIEW APPS.XX_BI_REV_DAILY_RPT_V;

/* Formatted on 6/6/2016 4:59:01 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_BI_REV_DAILY_RPT_V
(
   ORDER_NUMBER,
   CUSTOMER_NUMBER,
   CUSTOMER,
...
CREATE OR REPLACE SYNONYM ETLEBSUSER.XX_BI_REV_DAILY_RPT_V FOR APPS.XX_BI_REV_DAILY_RPT_V;


GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON APPS.XX_BI_REV_DAILY_RPT_V TO ETLEBSUSER;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON APPS.XX_BI_REV_DAILY_RPT_V TO XXINTG;
