DROP VIEW APPS.XX_XRTX_PO_DOC_BUY_CNTRCT;

/* Formatted on 6/6/2016 4:56:26 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_BUY_CNTRCT
(
   BUYER_NAME,
   YEAR,
   TOTAL_CNT,
...
AS
     SELECT A.Buyer_name,
       ...
       FROM xx_xrtx_po_doc_buy_total2 A,
            xx_xrtx_po_doc_buy_cancel2 b,
            xx_xrtx_po_doc_buy_open2 c,
            xx_xrtx_po_doc_buy_closed2 d
