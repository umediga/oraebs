DROP VIEW APPS.XX_XRTX_PO_DOC_OU_V30;

/* Formatted on 6/6/2016 4:55:46 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_OU_V30
(
   OPERATING_UNIT,
   YEAR,
   TOTAL_CNT,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_po_doc_ou_v8 A,
          xx_xrtx_po_doc_ou_v9 b,
          xx_xrtx_po_doc_ou_v10 c,
          xx_xrtx_po_doc_ou_v11 d,
          xx_xrtx_po_doc_ou_v12 e,
          xx_xrtx_po_doc_ou_v13 f,
          xx_xrtx_po_doc_ou_v14 g
