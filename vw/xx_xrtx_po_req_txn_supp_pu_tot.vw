DROP VIEW APPS.XX_XRTX_PO_REQ_TXN_SUPP_PU_TOT;

/* Formatted on 6/6/2016 4:54:18 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_REQ_TXN_SUPP_PU_TOT
(
   SUPPLIER_NAME,
   YEAR,
   TOTAL_COUNT
