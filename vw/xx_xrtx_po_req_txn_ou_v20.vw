DROP VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_V20;

/* Formatted on 6/6/2016 4:54:30 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_V20
(
   OPERATING_UNIT,
   YEAR,
   TOTAL_CNT,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_po_req_txn_ou_v10 A,
          xx_xrtx_po_req_txn_ou_v11 b,
          xx_xrtx_po_req_txn_ou_v12 c,
          xx_xrtx_po_req_txn_ou_v13 d,
          xx_xrtx_po_req_txn_ou_v14 e,
          xx_xrtx_po_req_txn_ou_v15 f,
          xx_xrtx_po_req_txn_ou_v16 g,
          xx_xrtx_po_req_txn_ou_v17 h,
          xx_xrtx_po_req_txn_ou_v18 i
