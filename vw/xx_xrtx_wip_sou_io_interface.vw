DROP VIEW APPS.XX_XRTX_WIP_SOU_IO_INTERFACE;

/* Formatted on 6/6/2016 4:54:02 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_WIP_SOU_IO_INTERFACE
(
   SOURCE,
   ORGANIZATION_ID,
