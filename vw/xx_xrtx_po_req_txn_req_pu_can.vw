DROP VIEW APPS.XX_XRTX_PO_REQ_TXN_REQ_PU_CAN;

/* Formatted on 6/6/2016 4:54:23 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_REQ_TXN_REQ_PU_CAN
(
   REQUESTOR_NAME,
   YEAR,
   CANCEL_COUNT
