DROP VIEW APPS.XX_XRTX_AP_INV_TXN_VS_SUP_V3;

/* Formatted on 6/6/2016 4:57:20 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_AP_INV_TXN_VS_SUP_V3
(
   SUPPLIER_NAME,
   YEAR,
   VALIDATION_STATUS,
   NEVER_VALIDATED_COUNT
)
AS
