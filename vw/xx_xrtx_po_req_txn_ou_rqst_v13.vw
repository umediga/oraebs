DROP VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_RQST_V13;

/* Formatted on 6/6/2016 4:54:52 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_RQST_V13
(
   OPERATING_UNIT,
   REQUESTOR_NAME,
   YEAR,
