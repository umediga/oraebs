DROP VIEW APPS.XX_XRTX_PO_DOC_OU_V32;

/* Formatted on 6/6/2016 4:55:46 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_OU_V32
(
   OPERATING_UNIT,
   YEAR,
   TOTAL_CNT,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_po_doc_ou_v22 A,
          xx_xrtx_po_doc_ou_v23 b,
          xx_xrtx_po_doc_ou_v24 c,
          xx_xrtx_po_doc_ou_v25 d,
          xx_xrtx_po_doc_ou_v26 e,
          xx_xrtx_po_doc_ou_v27 f,
          xx_xrtx_po_doc_ou_v28 g
