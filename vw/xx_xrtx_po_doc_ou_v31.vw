DROP VIEW APPS.XX_XRTX_PO_DOC_OU_V31;

/* Formatted on 6/6/2016 4:55:46 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_OU_V31
(
   OPERATING_UNIT,
   YEAR,
   TOTAL_CNT,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_po_doc_ou_v15 A,
          xx_xrtx_po_doc_ou_v16 b,
          xx_xrtx_po_doc_ou_v17 c,
          xx_xrtx_po_doc_ou_v18 d,
          xx_xrtx_po_doc_ou_v19 e,
          xx_xrtx_po_doc_ou_v20 f,
          xx_xrtx_po_doc_ou_v21 g
