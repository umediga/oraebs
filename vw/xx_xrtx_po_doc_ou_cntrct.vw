DROP VIEW APPS.XX_XRTX_PO_DOC_OU_CNTRCT;

/* Formatted on 6/6/2016 4:56:03 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_OU_CNTRCT
(
   OPERATING_UNIT,
   YEAR,
   TOTAL_CNT,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_po_doc_ou_total2 A,
          xx_xrtx_po_doc_ou_cancel2 b,
          xx_xrtx_po_doc_ou_open2 c,
          xx_xrtx_po_doc_ou_closed2 d
