DROP VIEW APPS.XX_XRTX_PO_DOC_SUPP_V32;

/* Formatted on 6/6/2016 4:55:22 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_SUPP_V32
(
   OPERATING_UNIT,
   SUPPLIER_NAME,
   YEAR,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_po_doc_supp_v22 A,
          xx_xrtx_po_doc_supp_v23 b,
          xx_xrtx_po_doc_supp_v24 c,
          xx_xrtx_po_doc_supp_v25 d,
          xx_xrtx_po_doc_supp_v26 e,
          xx_xrtx_po_doc_supp_v27 f,
          xx_xrtx_po_doc_supp_v28 g
