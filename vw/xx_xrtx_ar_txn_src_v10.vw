DROP VIEW APPS.XX_XRTX_AR_TXN_SRC_V10;

/* Formatted on 6/6/2016 4:56:51 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_AR_TXN_SRC_V10
(
   SOURCE_NAME,
   CREATION_DATE,
   TRANSACTION_NAME,
...
AS
   SELECT A.source_name,
     ...
     FROM xx_xrtx_ar_txn_src_v5 A,
          xx_xrtx_ar_txn_src_v6 b,
          xx_xrtx_ar_txn_src_v7 c,
          xx_xrtx_ar_txn_src_v8 d
