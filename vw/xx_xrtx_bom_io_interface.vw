DROP VIEW APPS.XX_XRTX_BOM_IO_INTERFACE;

/* Formatted on 6/6/2016 4:56:46 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_BOM_IO_INTERFACE
(
   ORGANIZATION_ID,
...
AS
     SELECT A.organization_id AS organization_id,
       ...
       FROM bom_bill_of_materials A, hr_all_organization_units b
