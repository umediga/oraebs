DROP VIEW APPS.XX_XRTX_PO_DOC_SUPPLIER_WISE_V;

/* Formatted on 6/6/2016 4:55:42 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_SUPPLIER_WISE_V
(
   SUPPLIER_NAME,
   YEAR,
   DOCUMENT_TYPE,
