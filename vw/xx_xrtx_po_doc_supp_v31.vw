DROP VIEW APPS.XX_XRTX_PO_DOC_SUPP_V31;

/* Formatted on 6/6/2016 4:55:23 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_SUPP_V31
(
   OPERATING_UNIT,
   SUPPLIER_NAME,
   YEAR,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_po_doc_supp_v15 A,
          xx_xrtx_po_doc_supp_v16 b,
          xx_xrtx_po_doc_supp_v17 c,
          xx_xrtx_po_doc_supp_v18 d,
          xx_xrtx_po_doc_supp_v19 e,
          xx_xrtx_po_doc_supp_v20 f,
          xx_xrtx_po_doc_supp_v21 g
