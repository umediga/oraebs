DROP VIEW APPS.XX_XRTX_PO_DOC_SUPP_PLANNED;

/* Formatted on 6/6/2016 4:55:35 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_SUPP_PLANNED
(
   SUPPLIER_NAME,
   YEAR,
   TOTAL_CNT,
...
AS
     SELECT A.supplier_name,
       ...
       FROM xx_xrtx_po_doc_supp_total3 A,
            xx_xrtx_po_doc_supp_cancel3 b,
            xx_xrtx_po_doc_supp_open3 c,
            xx_xrtx_po_doc_supp_closed3 d
