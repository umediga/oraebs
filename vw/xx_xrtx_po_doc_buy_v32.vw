DROP VIEW APPS.XX_XRTX_PO_DOC_BUY_V32;

/* Formatted on 6/6/2016 4:56:11 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_BUY_V32
(
   OPERATING_UNIT,
   BUYER_NAME,
   YEAR,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_po_doc_buy_v22 A,
          xx_xrtx_po_doc_buy_v23 b,
          xx_xrtx_po_doc_buy_v24 c,
          xx_xrtx_po_doc_buy_v25 d,
          xx_xrtx_po_doc_buy_v26 e,
          xx_xrtx_po_doc_buy_v27 f,
          xx_xrtx_po_doc_buy_v28 g
