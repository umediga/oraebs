DROP VIEW APPS.XX_XRTX_AR_TXN_OU_V10;

/* Formatted on 6/6/2016 4:56:55 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_AR_TXN_OU_V10
(
   OPERATING_UNIT,
   CREATION_DATE,
   TRANSACTION_NAME,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_ar_txn_ou_v5 A,
          xx_xrtx_ar_txn_ou_v6 b,
          xx_xrtx_ar_txn_ou_v7 c,
          xx_xrtx_ar_txn_ou_v8 d
