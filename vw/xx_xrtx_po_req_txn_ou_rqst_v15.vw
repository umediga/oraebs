DROP VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_RQST_V15;

/* Formatted on 6/6/2016 4:54:51 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_RQST_V15
(
   OPERATING_UNIT,
   REQUESTOR_NAME,
   YEAR,
