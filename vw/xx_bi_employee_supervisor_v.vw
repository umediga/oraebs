DROP VIEW APPS.XX_BI_EMPLOYEE_SUPERVISOR_V;

/* Formatted on 6/6/2016 4:59:56 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_BI_EMPLOYEE_SUPERVISOR_V
(
   EMPLOYEE_NUMBER,
   EMPLOYEE_NAME,
   JOB,
...
CREATE OR REPLACE SYNONYM ETLEBSUSER.XX_BI_EMPLOYEE_SUPERVISOR_V FOR APPS.XX_BI_EMPLOYEE_SUPERVISOR_V;


CREATE OR REPLACE SYNONYM XXAPPSREAD.XX_BI_EMPLOYEE_SUPERVISOR_V FOR APPS.XX_BI_EMPLOYEE_SUPERVISOR_V;


CREATE OR REPLACE SYNONYM XXBI.XX_BI_EMPLOYEE_SUPERVISOR_V FOR APPS.XX_BI_EMPLOYEE_SUPERVISOR_V;


CREATE OR REPLACE SYNONYM XXINTG.XX_BI_EMPLOYEE_SUPERVISOR_V FOR APPS.XX_BI_EMPLOYEE_SUPERVISOR_V;


GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON APPS.XX_BI_EMPLOYEE_SUPERVISOR_V TO ETLEBSUSER;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON APPS.XX_BI_EMPLOYEE_SUPERVISOR_V TO XXAPPSREAD;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON APPS.XX_BI_EMPLOYEE_SUPERVISOR_V TO XXINTG;
