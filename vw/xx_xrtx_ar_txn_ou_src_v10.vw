DROP VIEW APPS.XX_XRTX_AR_TXN_OU_SRC_V10;

/* Formatted on 6/6/2016 4:57:00 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_AR_TXN_OU_SRC_V10
(
   OPERATING_UNIT,
   SOURCE_NAME,
   CREATION_DATE,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_ar_txn_ou_src_v5 A,
          xx_xrtx_ar_txn_ou_src_v6 b,
          xx_xrtx_ar_txn_ou_src_v7 c,
          xx_xrtx_ar_txn_ou_src_v8 d
