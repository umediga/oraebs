DROP VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_SUPP_V6;

/* Formatted on 6/6/2016 4:54:37 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_SUPP_V6
(
   OPERATING_UNIT,
   SUPPLIER_NAME,
   YEAR,
