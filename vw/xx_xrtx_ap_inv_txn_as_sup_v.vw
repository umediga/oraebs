DROP VIEW APPS.XX_XRTX_AP_INV_TXN_AS_SUP_V;

/* Formatted on 6/6/2016 4:57:48 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_AP_INV_TXN_AS_SUP_V
(
   SUPPLIER_NAME,
   YEAR,
   APPROVAL_TYPE,
...
AS
   SELECT b.vendor_name supplier_name,
          ...
          a.wfapproval_status Approval_type,
