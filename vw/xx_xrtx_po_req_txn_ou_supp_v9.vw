DROP VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_SUPP_V9;

/* Formatted on 6/6/2016 4:54:36 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_SUPP_V9
(
   OPERATING_UNIT,
   SUPPLIER_NAME,
   YEAR,
