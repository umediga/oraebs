DROP VIEW APPS.XX_XRTX_PO_DOC_SUPP_CNTRCT;

/* Formatted on 6/6/2016 4:55:37 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_SUPP_CNTRCT
(
   SUPPLIER_NAME,
   YEAR,
   TOTAL_CNT,
...
AS
     SELECT A.supplier_name,
       ...
       FROM xx_xrtx_po_doc_supp_total2 A,
            xx_xrtx_po_doc_supp_cancel2 b,
            xx_xrtx_po_doc_supp_open2 c,
            xx_xrtx_po_doc_supp_closed2 d
