DROP VIEW APPS.XXIEX_INTL_ORDERS_ON_HOLD_V;

/* Formatted on 6/6/2016 5:00:25 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XXIEX_INTL_ORDERS_ON_HOLD_V
(
   IEU_OBJECT_FUNCTION,
...
CREATE OR REPLACE SYNONYM XXAPPSREAD.XXIEX_INTL_ORDERS_ON_HOLD_V FOR APPS.XXIEX_INTL_ORDERS_ON_HOLD_V;


GRANT SELECT ON APPS.XXIEX_INTL_ORDERS_ON_HOLD_V TO XXAPPSREAD;
