DROP VIEW APPS.XX_XRTX_PO_REL_OU_V;

/* Formatted on 6/6/2016 4:55:08 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_REL_OU_V
(
   OPERATING_UNIT,
   YEAR,
   RELEASE_TYPE,
...
AS
   SELECT hou.NAME operating_unit,
    ...
    WHERE A.org_id = hou.organization_id AND release_type = 'BLANKET'
   UNION ALL
   SELECT hou.NAME operating_unit,
          TO_CHAR (TRUNC (A.creation_date), 'YYYY') YEAR,
          'BLANKET' release_type,
