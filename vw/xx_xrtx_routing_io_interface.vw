DROP VIEW APPS.XX_XRTX_ROUTING_IO_INTERFACE;

/* Formatted on 6/6/2016 4:54:15 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_ROUTING_IO_INTERFACE
(
   ORGANIZATION_ID,
...
AS
     SELECT A.organization_id AS organization_id,
       ...
       FROM bom_operational_routings A, hr_all_organization_units b
