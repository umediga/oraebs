DROP VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_SUPP_V10;

/* Formatted on 6/6/2016 4:54:44 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_REQ_TXN_OU_SUPP_V10
(
   OPERATING_UNIT,
   SUPPLIER_NAME,
   YEAR,
