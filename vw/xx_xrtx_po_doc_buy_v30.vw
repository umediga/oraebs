DROP VIEW APPS.XX_XRTX_PO_DOC_BUY_V30;

/* Formatted on 6/6/2016 4:56:12 PM (QP5 v5.277) */
CREATE OR REPLACE FORCE VIEW APPS.XX_XRTX_PO_DOC_BUY_V30
(
   OPERATING_UNIT,
   BUYER_NAME,
   YEAR,
...
AS
   SELECT A.operating_unit,
     ...
     FROM xx_xrtx_po_doc_buy_v8 A,
          xx_xrtx_po_doc_buy_v9 b,
          xx_xrtx_po_doc_buy_v10 c,
          xx_xrtx_po_doc_buy_v11 d,
          xx_xrtx_po_doc_buy_v12 e,
          xx_xrtx_po_doc_buy_v13 f,
          xx_xrtx_po_doc_buy_v14 g
