DROP TABLE APPS.XXOM_IMP_ONHAND_CONV_TEMP CASCADE CONSTRAINTS;

CREATE TABLE APPS.XXOM_IMP_ONHAND_CONV_TEMP
(
...
GRANT SELECT ON APPS.XXOM_IMP_ONHAND_CONV_TEMP TO XXAPPSREAD;
